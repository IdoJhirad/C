...
{
	{ lut_handler[WAIT_FOR_NUM]['('] ; WAIT_FOR_NUM 	; WAIT_FOR_NUM 	},
	{ lut_handler[WAIT_FOR_NUM]['+'] ; WAIT_FOR_NUM 	; WAIT_FOR_NUM	},
	{ lut_handler[WAIT_FOR_NUM]['-'] ; WAIT_FOR_NUM 	; WAIT_FOR_NUM  },
	{ lut_handler[WAIT_FOR_NUM][' '] ; WAIT_FOR_NUM 	; WAIT_FOR_NUM  },
	
	{ lut_handler[WAIT_FOR_NUM]['1']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['2']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['3']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['4']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['5']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['6']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR }
	{ lut_handler[WAIT_FOR_NUM]['7']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['8']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	{ lut_handler[WAIT_FOR_NUM]['9']  ; WAIT_FOR_NUM 	; WAIT_FOR_OPERATOR },
	
	{ lut_handler[WAIT_FOR_OPERATOR]['(']	; WAIT_FOR_OPERATOR	; WAIT_FOR_OPERATOR	},
	{ lut_handler[WAIT_FOR_OPERATOR]['+']	; WAIT_FOR_OPERATOR	; WAIT_FOR_NUM		},
	{ lut_handler[WAIT_FOR_OPERATOR]['-']   ; WAIT_FOR_OPERATOR	; WAIT_FOR_NUM		},
	{ lut_handler[WAIT_FOR_OPERATOR]['*']   ; WAIT_FOR_OPERATOR	; WAIT_FOR_NUM		},
	{ lut_handler[WAIT_FOR_OPERATOR]['/']   ; WAIT_FOR_OPERATOR	; WAIT_FOR_NUM		},
	{ lut_handler[WAIT_FOR_OPERATOR]['^']   ; WAIT_FOR_OPERATOR 	; WAIT_FOR_NUM 		},
	{ lut_handler[WAIT_FOR_OPERATOR]['\0']  ; WAIT_FOR_OPERATOR 	; WAIT_FOR_NUM 		},
	{ lut_handler[WAIT_FOR_OPERATOR][' ']   ; WAIT_FOR_OPERATOR 	; WAIT_FOR_OPERATOR }

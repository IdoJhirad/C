...
typedef struct scheduler scheduler_heap_t;
...
space complexity: O(1)
*/
void SchedulerDestroy(scheduler_heap_t *scheduler);
...
space complexity: O(1)
*/
ilrd_uid_t SchedulerAdd(scheduler_heap_t *scheduler,
                    time_t exec_time, 
...
space complexity: O(1)
*/
int SchedulerRemove(scheduler_heap_t *scheduler, ilrd_uid_t uid);
...
*/
int SchedulerRun(scheduler_heap_t *scheduler);
...
space complexity:O(1)
*/
void SchedulerStop(scheduler_heap_t *scheduler);
...
space complexity: O(1)  
*/
size_t SchedulerSize(scheduler_heap_t *scheduler);
...
space complexity: O(1)
*/
int SchedulerIsEmpty(scheduler_heap_t *scheduler);
...
space complexity: O(1)
*/
void SchedulerClear(scheduler_heap_t *scheduler);

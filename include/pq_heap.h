...
*/
pq_heap_t *PQCreate(pq_compare_func_t cmp_func);
...
space complexity: O(1)
*/
void PQDestroy(pq_heap_t *queue);
...
space complexity: O(1)
*/
int PQEnqueue(pq_heap_t *queue, void *data);
...
space complexity: O(1)
*/
void *PQDequeue(pq_heap_t *queue);
...
Space Complexity: O(1)
 */
void *PQPeek(const pq_heap_t *queue);
...
space complexity: O(1)
*/
int PQIsEmpty(const pq_heap_t *queue);
...
space complexity: O(1)
*/
size_t PQSize(const pq_heap_t *queue);
...
space complexity: O(1)
*/
void *PQErase(pq_heap_t *queue, pq_match_func_t is_match, void *param);
#endif /*__PQ_H__*/
